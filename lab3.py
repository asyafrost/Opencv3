...
class Image_:
    ...
    def Gucci_flip_flap(money):
        ...
        image = cv2.imread("smechariki.jpg")
    ...
    def Rotate(self):
        ...
        cv2.imwrite("Img.jpg", warp_rotate_dst)
...
def Menu():
    ...
    #btn = Button(window, text="Черно-белая версия фото", padx=5, pady=5, command =img.Black_White , bg='#eec6ea')  
    #btn.pack(anchor="center", padx=20, pady=10)

    #btn1 = Button(window, text="Сепия версия", padx=5, pady=5, command = img.Sepia, bg='#eec6ea')  
    #btn1.pack(anchor="center", padx=20, pady=10)

    #btn2 = Button(window, text="HSV", padx=5, pady=5, command = img.set_hsv, bg='#eec6ea')  
    #btn2.pack(anchor="center", padx=20, pady=10)

    btn3 = Button(window, text="Проекция на плоскость", padx=5, pady=5, command = img.Proection, bg='#eec6ea')  
    btn3.pack(anchor="center", padx=20, pady=20)

   # btn5 = Button(window, text="Координаты", padx=5, pady=5, command = img.Point, bg='#eec6ea')  
   # btn5.pack(anchor="center", padx=20, pady=20)

    

    

    btn7 = Button(window, text="Масштабирование", padx=5, pady=5, command = menu_s, bg='#eec6ea')  
    btn7.pack(anchor="center", padx=20, pady=20)

    btn8 = Button(window, text="Поворот", padx=5, pady=5, command =menu_r , bg='#eec6ea')  
    btn8.pack(anchor="center", padx=20, pady=20)

    btn9 = Button(window, text="Изменение плоскости", padx=5, pady=5, command =img.Rotate , bg='#eec6ea')  
    btn9.pack(anchor="center", padx=20, pady=20)
    
    btn10 = Button(window, text="Сдвиг", padx=5, pady=5, command =menu_sh , bg='#eec6ea')  
    btn10.pack(anchor="center", padx=20, pady=20)
    
    btn6 = Button(window, text="Отражение", padx=5, pady=5, command =menu_f , bg='#eec6ea')  
    btn6.pack(anchor="center", padx=20, pady=20)

    btn4 = Button(window, text="Выход", padx=5, pady=5, command = exit, bg='#eec6ea')  
    btn4.pack(anchor="center", padx=20, pady=20)
